    ...
    public void service(HttpServletRequest req, HttpServletResponse res) throws ServletException, IOException
    {
        ...
        try
        {
            ...
            if(rs.next()) {
                ...
                out.println("<div class='alert alert-danger' role='alert'>Le login "+ login +" est déja utilisé, veuillez en choisir un autre.");
                ...
                out.println("<div class='alert alert-success' role='alert'>Bienvenue " + prenom + ", ! Votre compte à bien été créé !");
